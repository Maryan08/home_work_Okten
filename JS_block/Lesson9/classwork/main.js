...
//     // div.innerText = `${simps.name},${simps.surname},${simps.age},${simps.info},${simps.photo}\n`;
//     div.innerText = simps.name+' '+simps.surname+' '+simps.age+' '+simps.info+' '+simps.photo+'\n';
...
//     name_div.innerText = el.name;
//     let surname_div = document.createElement('div');
//     surname_div.innerText = el.surname;
//     let age_div = document.createElement('div');
//     age_div.innerText = el.age;
//     let info_div = document.createElement('div');
//     info_div.innerText = el.info;
//     let photo_div = document.createElement('img');
//     photo_div.innerText = el.photo;
//
//     div.append(name_div, surname_div, age_div, info_div, photo_div);
//
// }
...
for (const el of coursesArray) {
    ...
    div_wrap.style.display = 'flex';
    div_wrap.style.columnGap = '20px';
    let monthDuration = document.createElement('div');
    monthDuration.innerText = el.monthDuration;
    monthDuration.style.border = '1px solid blue';
    let hourDuration = document.createElement('div');
    hourDuration.innerText = el.hourDuration;
    hourDuration.style.border = '1px solid blue';
    div_wrap.append(monthDuration, hourDuration);
    let ul_wrap = document.createElement('ul');
    ;
    for (const module of el.modules) {
        let liElement = document.createElement('li')
        liElement.innerText = module;
        ul_wrap.append(liElement);
    }

    mainBlock.append(title, div_wrap, ul_wrap);
}
